...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'plantillasCorreo.html'
        db.alter_column(u'cmsTuk_plantillascorreo', 'html', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'plantillasCorreo.html'
        db.alter_column(u'cmsTuk_plantillascorreo', 'html', self.gf('django.db.models.fields.TextField')())
