...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'socialmediaPlugin.video'
        db.delete_column(u'cmsplugin_socialmediaplugin', 'video')

        # Adding field 'socialmediaPlugin.videoYT'
        db.add_column(u'cmsplugin_socialmediaplugin', 'videoYT',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'socialmediaPlugin.video'
        db.add_column(u'cmsplugin_socialmediaplugin', 'video',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'socialmediaPlugin.videoYT'
        db.delete_column(u'cmsplugin_socialmediaplugin', 'videoYT')
