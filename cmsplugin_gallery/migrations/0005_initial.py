...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'tukgallery', ['GalleryPlugin'])

        # Adding model 'Image'
        db.create_table(u'tukgallery_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tukgallery.GalleryPlugin'])),
        ...
        db.send_create_signal(u'tukgallery', ['Image'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'tukgallery_image')
    ...
    models = {
        ...
        u'tukgallery.image': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tukgallery.GalleryPlugin']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
